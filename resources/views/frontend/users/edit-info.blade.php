...
@section('content')
    <div class="col-lg-9 col-12">
        ...
        {!! Form::open(['route'=>'frontend.dashboard.update-info' ,'name'=>'user_info','id'=>'user_info', 'method'=>'post' , 'files'=>true]) !!}
        <div class="row">
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    {!! Form::submit('Update Information',['name'=>'update_info','class'=>'btn btn-primary']) !!}
                </div>
            </div>
        </div>
        {!! Form::close() !!}
        ...
        <h3 class="mt-3 mb-2">Edit Password</h3>
        {!! Form::open(['route'=>'frontend.dashboard.update-password' ,'name'=>'user_password', 'id'=>'user_password','method'=>'post']) !!}
            <div class="row">
                <div class="col-4">
                    <div class="form-group">

...
@section('content')
    <div class="col-lg-9 col-12">
        <div class="blog-page">
            <h3 class="mb-2">Edit comment on : ({{$comment->post->title}})</h3>
            {!! Form::model($comment ,['route'=>['frontend.dashboard.update.comment' , $comment->id] , 'method'=>'put']) !!}
            <div class="row">
                <div class="col-3">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        {!! Form::url('url', old('email',$comment->url),['class'=>'form-control']) !!}

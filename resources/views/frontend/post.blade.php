    ...
    <div class="col-lg-9 col-12">
        <div class="blog-details content">
                    ...
                    <div class="post_header">
                        ...
                        <div class="blog-date-categori">
                            <ul>
                                ...
                                <li><a href="{{route('frontend.author.post',$post->user->username)}}" title="Posts by {{$post->user->name}}" rel="author">{{$post->user->name}}</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="comment_respond">
                ...
                {!! Form::open(['route'=>['add_comment',$post->slug] , 'method'=>'post' , 'class'=>'comment__form']) !!}
